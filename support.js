...
{ 
  ...
  // 4. Information
  info = createP("<b> Please Read the Instructions </b><br>The circle that you need to press is presented in tones of green with a blinking border and will turn to shade of teal when the mouse is hovering the target<br> If the next and previous targets coincide, '2x' will be written on the circle, which will painted green with a red border<br>The next target is painted red<br> The test starts when you press the start button");
  info.id('info');
